...
#include "HeterogeneousVolumeExComponent.generated.h"


class USparseVolumeTexture;

/**
 *	A component that represents a heterogeneous volume, with extended interface to the renderer allowing higher quality rendering
 */
...
class UHeterogeneousVolumeExComponent : public UMeshComponent
{
...
public:
	...
	HVPT_API void SetVolumeResolution(FIntVector NewValue);

	UFUNCTION(BlueprintCallable, Category = "Animation")
	HVPT_API void SetFrame(float NewValue);

	UFUNCTION(BlueprintCallable, Category = "Animation")
	HVPT_API void SetFrameRate(float NewValue);

	UFUNCTION(BlueprintCallable, Category = "Animation")
	HVPT_API void SetStartFrame(float NewValue);

	UFUNCTION(BlueprintCallable, Category = "Animation")
	HVPT_API void SetEndFrame(float NewValue);

	UFUNCTION(BlueprintCallable, Category = "Animation")
	HVPT_API void SetPlaying(bool NewValue);

	UFUNCTION(BlueprintCallable, Category = "Animation")
	HVPT_API void SetLooping(bool NewValue);

	UFUNCTION(BlueprintCallable, Category = "Animation")
	HVPT_API void Play();

	UFUNCTION(BlueprintCallable, Category = "SparseVolumeTextureStreaming")
	HVPT_API void SetStreamingMipBias(int32 NewValue);

	~UHeterogeneousVolumeExComponent() {}
...
class AHeterogeneousVolumeEx : public AInfo
{
	GENERATED_UCLASS_BODY()
...
private:
	...
	TObjectPtr<UHeterogeneousVolumeExComponent> HeterogeneousVolumeExComponent;
